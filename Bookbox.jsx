            ...
            <div className="container mx-auto p-8 items-center justify-center flex">
                <div className="space-x-6 flex flex-row">
                    <div className="h-full rounded-lg overflow-hidden transform transition-transform cursor-pointer duration-300 hover:scale-105">
                        <img
                            className="h-[20rem] w-64"
                            src="https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9788965422785.jpg"/>
                        <p className="mt-[0.9rem] font-normal text-[0.79rem] text-gray-500">외국어</p>
                        <p className="mt-[0.25rem] font-bold text-[0.95rem]">해커스 토익 기출 VOCA</p>
                        <p className="mt-[0.3rem] font-normal text-[0.79rem] text-gray-500">David Cho</p>
                    ...
                    <div className="h-full rounded-lg overflow-hidden transform transition-transform cursor-pointer duration-300 hover:scale-105">
                        ...
                        <p className="mt-[0.9rem] font-normal text-[0.79rem] text-gray-500">경제/경영</p>
                        <p className="mt-[0.25rem] font-bold text-[0.95rem]">THE MONEY BOOK</p>
                        <p className="mt-[0.3rem] font-normal text-[0.79rem] text-gray-500">토스</p>
                    </div>
                    <div className="h-full rounded-lg overflow-hidden transform transition-transform cursor-pointer duration-300 hover:scale-105">
                        <img
                            className="h-[20rem] w-64"
                            src="https://contents.kyobobook.co.kr/sih/fit-in/300x0/pdt/9791193506516.jpg"/>
                        <p className="mt-[0.9rem] font-normal text-[0.79rem] text-gray-500">인문</p>
                        <p className="mt-[0.25rem] font-bold text-[0.95rem]">초역 부처의 말</p>
                        <p className="mt-[0.3rem] font-normal text-[0.79rem] text-gray-500">코이케 류노스케</p>
                    </div>
                    <div
                        className="h-full rounded-lg overflow-hidden transform transition-transform cursor-pointer duration-300 hover:scale-105">
                        <img
                        ...
                        <p className="mt-[0.9rem] font-normal text-[0.79rem] text-gray-500">경제/경영</p>
                        <p className="mt-[0.25rem] font-bold text-[0.95rem]">불변의 법칙</p>
                        <p className="mt-[0.3rem] font-normal text-[0.79rem] text-gray-500">모건 하우절</p>
                    </div>
                </div>
            </div>
        )
